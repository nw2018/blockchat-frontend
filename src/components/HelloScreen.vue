<template>
  <div class="welcome">
    <div class="image">
      <svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="182.000000pt" height="32.000000pt" viewBox="0 0 364.000000 65.000000" preserveAspectRatio="xMidYMid meet">
        <g transform="translate(0.000000,65.000000) scale(0.100000,-0.100000)" fill="#ecf0f1" stroke="#bdc3c7" stroke-width="10" fill-opacity="0">
    ...
    <div style="min-height:10em;">
      <transition name="fade">
        <mt-button @click="toHome" v-show="showButton" class="wel-button" plain>Start Here</mt-button>
      </transition>
    </div>
...
path {
  ...
  animation: dash 3s ease-in-out forwards, fadein 1s ease-in forwards;
